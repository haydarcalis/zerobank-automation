...
//            BrowserUtils.waitForStaleElement(Driver.get().findElement(By.xpath(moduleLocator)));
    ...
    public void selectFrom(String selectElementName, String optionText) {
        new Select(Driver.get().findElement(By.name(selectElementName))).selectByVisibleText(optionText);
    }
    ...
    public void enterDataTo(String data, String element) {
        ...
        if (element.equals("account")) {
            Driver.get().findElement(By.xpath("//input[@name='account']")).sendKeys(data);
        } else {
            Driver.get().findElement(By.name(element)).clear();
            Driver.get().findElement(By.name(element)).sendKeys(data);
        }
    }
}